...
// Example chaining different functions
...
const sortSanFrancisco = curriedSort(filteredPlayersBySanFrancisco);
const sortSFByAge = sortSanFrancisco("age");
console.log(sortSFByAge);